module FileUtils
  ...
  LOW_METHODS = [:pwd, :getwd, :cd, :chdir, :uptodate?, :copy_entry, :copy_file, :copy_stream, :remove_entry_secure, :remove_entry, :remove_file, :remove_dir, :compare_file, :identical?, :cmp, :compare_stream]
